...
public class RightButton extends CommandButton implements IScreen
{
    RightRotateCommand rightRotateCommand;
    ImageContainerBoard receiver = new ImageContainerBoard();
    public static boolean rightbutton_pressed = false;
    ...
    { 
        World pw = getWorld();
        rightRotateCommand = new RightRotateCommand(pw);
        rightRotateCommand.setReceiverScreen(receiver);
        rightRotateCommand.executeCommand();
    }
