 ...
 * which ensures that GameWorld does its update before anything else
...
public abstract class GameWorld extends World
{
    ...
    /**
     * Constructs a GameWorld that is 640 by 480 pixels,
    ...
    /**
     * Constructs a GameWorld that is scaled and may have depth available.
     *
     ...
     * from the Kinect.  GameWorld can do this for you, and will scale up
     ...
     * if you enable it.
     */
    public GameWorld(double scale, boolean depth)
    {
     ...
     */
    public GameWorld(int thumbnailWidth, int thumbnailHeight, double scale, boolean depth)
    {
     ...
     * interface.  If everything is working properly, GameWorld should
     ...
     * This can be useful if you used one of GameWorld's alternate
